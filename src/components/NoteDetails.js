...
class NoteDetails extends Component {
    ...
    async componentDidMount() {
        ...
        if (this.props.messageToFocus) {
            let name = await api.query.nameService.nameOf(this.props.messageToFocus.sender.address);
            if (name.toHuman() !== null) {
                this.setState({accountNameValue: name.toHuman()[0]})
            } else {
                this.setState({accountNameValue: this.props.messageToFocus.sender.address})
            }
        }
    }
                    ...
                    <div className="header-row">
                        ...
                        {this.props.messageToFocus.sender ? (
                            <div className="sender-info-container">
                                ...
                                >
                                    {this.state.accountNameValue !== this.props.messageToFocus.sender.address
